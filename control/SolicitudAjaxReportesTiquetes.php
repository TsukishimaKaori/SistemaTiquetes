...
if (isset($_POST['codigoAreaCalificacion'])) {
    $codigoArea = $_POST['codigoAreaCalificacion'];
    $empleados = reportePromedioCalificacionesPorResponsables($codigoArea);
    reportesCalificacionesEmpleado($empleados);
}

function reportesCalificacionesEmpleado($empleados) {
    foreach ($empleados as $empleado) {
        echo "<tr>";
        echo "<td style='text-align: center;'>" . $empleado->obtenerNombreResponsable() . "</td>";
        echo "<td style='text-align: center;'>" . $empleado->obtenerPromedioCalificiones() . "</td>";
        echo "</tr>";
    }
}
