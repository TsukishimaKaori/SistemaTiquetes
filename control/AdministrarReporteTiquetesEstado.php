...
function buscarEstado($cantidad,$descripcion){
    foreach ($cantidad as $c) {
        if($c->obtenerNombreEstado()==$descripcion){
...
// tabla de datos
function tablaTiquetes($estado,$cantidad,$tiquetes){
                          echo'  <div id="graficoRendimientoPorAreaTematica" class="panel panel-default grafico">
                                ...
                                <div class="row" >
                                    <div style = "padding: 2%">
                                        <div  class="table table-hover table-responsive " >                  
                                            <table id=\'mitablaTiquetes\' class = "tablaReportes table table-hover">                
                                                <thead>
                                                    <tr > 
                                                ...
                                                <tbody  id = "tbodyTiquetes">';  
                                                  ...
                                                  echo  cuerpoTablaReportes($tiquetes);
